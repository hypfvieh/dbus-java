...
This library has been tested with Ubuntu 16.04.2 (AMD64) and bluez library 5.43.

##### To build a newer bluez-library for Ubuntu (16.04 has an older version than 5.43):
-------------
...
&nbsp;&nbsp;&nbsp;&nbsp;`sudo apt-get install libdbus-1-dev libudev-dev libical-dev libreadline-dev checkinstall`
4. Extract the downloaded bluez-tarball:  
&nbsp;&nbsp;&nbsp;&nbsp;`tar xfvJ bluez-5.43.tar.xz`
